...
def process_svg_data(svg_file, coordinates, connections, db_path):
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        floor_number = int(re.findall(r"\d", svg_file)[-1])
...
if __name__ == "__main__":
    ...
    floor = loader.env_variables["floor_map"] / "AB-01"
    db_path = loader.env_variables["db_path"] / "ab01-01.db"
    for filename in os.listdir(floor):
        ...
        if os.path.isfile(filepath):
            ...
            process_svg_data(filepath, coordinates, connections, db_path)
